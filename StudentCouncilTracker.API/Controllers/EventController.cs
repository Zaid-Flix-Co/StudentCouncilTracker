...
using StudentCouncilTracker.Application.Features.Events.Commands.CreateEvent;
using StudentCouncilTracker.Application.Features.Events.Commands.DeleteEvent;
using StudentCouncilTracker.Application.Features.Events.Commands.UpdateEvent;
